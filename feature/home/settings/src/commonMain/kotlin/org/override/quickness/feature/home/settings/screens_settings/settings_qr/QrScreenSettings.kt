...
import org.override.quickness.feature.home.settings.components.DropdownSettings
import org.override.quickness.feature.home.settings.components.SettingsItemSwitch
import org.override.quickness.feature.home.settings.state.QrSettingsState
import org.override.quickness.shared.ui.styles.ShimmerListVertical
    ...
    LazyColumn(
        ...
        item {
            DropdownSettings(
                ...
                iconKey = viewModel.getDrawable(ResourceNameKey.ARROW_DROP_UP_24DP_E3E3E3_FILL0_WGHT400_GRAD0_OPSZ24.name),
                onOptionSelected = {
