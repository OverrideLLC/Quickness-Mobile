package org.override.quickness.shared.resources.strings
...
sealed class Strings {
    ...
    object TermsAndPolicies {
        ...
        const val TERMS_AND_CONDITIONS_DESCRIPTION =
    ...
    object QrSettings {
        ...
        const val IMPROVE_QR_READABILITY =
            "Activating this option improves the readability of the QR code by adjusting its design, ensuring better scanning compatibility with most devices."
    ...
    object AccountSettings {
        ...
        const val CHANGE_PASSWORD_INFO =
            "You can request a password change. You will receive an email with instructions."
        const val REQUEST_PASSWORD_CHANGE = "Request Password Change"
        const val DELETE_ACCOUNT = "Delete Account"
        const val DELETE_ACCOUNT_WARNING =
            "Deleting your account is an irreversible action. You will lose access to all your data and services associated with this account."
        const val CONFIRM_DELETE_ACCOUNT = "Delete Account"
        const val LOG_OUT = "Log Out"
        const val LOG_OUT_WARNING =
            "Logging out means you will need to sign in again to access your account."
